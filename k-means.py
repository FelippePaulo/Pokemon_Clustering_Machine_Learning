...
# plt.scatter(baseOriginal.loc[previsoes == 0, 'total'],baseOriginal.loc[previsoes == 0, 'type1'],s=100,c='blue',label='Cluster 0')
# plt.scatter(baseOriginal.loc[previsoes == 1, 'total'],baseOriginal.loc[previsoes == 1, 'type1'],s=100,c='red',label='Cluster 1')
# plt.scatter(baseOriginal.loc[previsoes == 2, 'total'],baseOriginal.loc[previsoes == 2, 'type1'],s=100,c='orange',label='Cluster 2')
# plt.scatter(baseOriginal.loc[previsoes == 3, 'total'],baseOriginal.loc[previsoes == 3, 'type1'],s=100,c='green',label='Cluster 3')
# plt.scatter(baseOriginal.loc[previsoes == 4, 'total'],baseOriginal.loc[previsoes == 4, 'type1'],s=100,c='purple',label='Cluster 4')
# plt.scatter(baseOriginal.loc[previsoes == 5, 'total'],baseOriginal.loc[previsoes == 5, 'type1'],s=100,c='yellow',label='Cluster 5')
# plt.scatter(baseOriginal.loc[previsoes == 6, 'total'],baseOriginal.loc[previsoes == 6, 'type1'],s=100,c='brown',label='Cluster 6')
# plt.scatter(baseOriginal.loc[previsoes == 7, 'total'],baseOriginal.loc[previsoes == 7, 'type1'],s=100,c='black',label='Cluster 7')
# plt.xlabel('total')
# plt.ylabel('tipo 1')
...
# plt.scatter(baseOriginal.loc[previsoes == 2, 'BILL_TOTAL'],baseOriginal.loc[previsoes == 2, 'PAY_TOTAL'],s=100,c='orange',label='Cluster 2')
# plt.scatter(baseOriginal.loc[previsoes == 0, 'BILL_TOTAL'],baseOriginal.loc[previsoes == 0, 'PAY_TOTAL'],s=100,c='blue',label='Cluster 0')
# plt.scatter(baseOriginal.loc[previsoes == 3, 'BILL_TOTAL'],baseOriginal.loc[previsoes == 3, 'PAY_TOTAL'],s=100,c='green',label='Cluster 3')
# plt.scatter(baseOriginal.loc[previsoes == 1, 'BILL_TOTAL'],baseOriginal.loc[previsoes == 1, 'PAY_TOTAL'],s=100,c='red',label='Cluster 1')
